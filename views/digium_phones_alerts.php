...
foreach ($alerts as $alert) {
	...
	<td valign="top" style="border-style:inset; border-width:0px; white-space: nowrap;" />
...
<input type="button" value="Add Alert" name="add_alert_submit" value="Add Alert" onclick="add_alert_clicked();"/>
</form>
...
<tr>
	<td colspan="2">
	<input type="submit" name="alertAddSubmit" id="alertAddSubmit" value="Save" disabled=true />
